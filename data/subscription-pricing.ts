...
/**
 * Public plans only. Growth ($5/mo, 200 subs) and Pro ($50/mo, 50,000 subs)
 * still exist in the app for legacy merchants but are not offered publicly,
 * so they are intentionally not listed on the website.
 */
export const SUBSCRIPTION_TIERS: SubscriptionTier[] = [
  ...
  },
  {
    ...
    yearly: 96,
    limit: "1,000",
    blurb: "Adds analytics and styling controls as your program grows.",
    features: [
...
export const SUBSCRIPTION_MATRIX: { label: string; cells: MatrixCell[] }[] = [
  ...
  { label: "0% transaction fees", cells: [true, true, true, true] },
  { label: "Widgets, recurring billing & customer portal", cells: [true, true, true, true] },
  { label: "Subscription analytics", cells: [null, true, true, true] },
  { label: "Custom CSS", cells: [null, true, true, true] },
  { label: "Customer portal customization", cells: [null, true, true, true] },
  { label: "Bundling & build-a-box", cells: [null, null, true, true] },
  { label: "Custom shipping profiles", cells: [null, null, true, true] },
  { label: "Custom email HTML", cells: [null, null, true, true] },
  { label: "Custom email domain", cells: [null, null, null, true] },
  { label: "Priority support", cells: [null, null, null, true] },
];
