...
// Lazy load the refined scene to avoid SSR issues and improve initial load
const RefinedCommerceScene = lazy(() =>
  import("./RefinedCommerceScene").then((mod) => ({ default: mod.RefinedCommerceScene }))
);
